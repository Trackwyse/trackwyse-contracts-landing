...
const sizeClasses = {
	sm: classNames(
		'rounded-md dropshadow-md py-2 px-9 text-base font-medium',
...
const colorClasses = {
	primary: classNames(
		'bg-blue-300 text-black border border-black',
		'hover:bg-blue-200'
	),
...
const Button: React.FC<ButtonProps> = ({
	...
	return (
		...
		>
			<div
				className={
					loading ? 'flex items-center opacity-0' : 'flex items-center'
				}
			>
			...
			{loading && (
				<RemixIcons.RiLoader3Line className='absolute animate-spin' size={24} />
			)}
		</button>
	);
};
